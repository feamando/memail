# GEMINI.md - Memail Agent Entry Point (Gemini)

## Project Overview

**Memail** is a [describe project purpose here]. This repository uses an AI-assisted development workflow with Gemini Code Assist.
